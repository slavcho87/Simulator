...
Poner el diagrama de navegación

\section{Elementos del simulador de escenarios}

Explicar los objetos dinamicos y estaticos

\section{Comportamiento de los objetos dinámicos}

Explicar como se ha desarrollado el tema del movimientos de los objetos dinámicos
