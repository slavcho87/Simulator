...
\includepdf[pages=-]{escaneos/Scan3.pdf}
\frontmatter
\tableofcontents
\listoffigures
\listoftables
...
%
\input{capitulos/03_Explotacion}
%w
\input{capitulos/04_GestionProyecto}
%
...
\input{anexos/02_Analisis}
\input{anexos/03_Implementacion}
\input{anexos/04_Integracion_Recomendador}
\input{anexos/05_Articulo}
