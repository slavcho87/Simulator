...
\begin{itemize}
	...
	\item Se ha desarrollado lo necesarios para que el simulador permita la simulación y recomendación de items basándose en las ubicaciones geográficas tanto de los usuarios como de los items a recomendar.
